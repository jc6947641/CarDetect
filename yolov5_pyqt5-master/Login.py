...
class MyWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.icon = QIcon("./IMG/gujilogo.png")
        ...
        self.setWindowTitle("车辆零部件缺陷检测系统登陆")
    ...
    def set_background_image(self):
        ...
        self.frame.move(165, 180)
        self.frame.setStyleSheet(
            'background-image: url("./IMG/guji.png"); background-repeat: no-repeat; text-align:center;')
    ...
    def sign_up_window(self):
        ...
        frame.setStyleSheet('background-image: url("./IMG/guji.png"); background-repeat: no-repeat;')
        frame.move(165, 180)
        # 打开注册窗口时，清除原来的信息
