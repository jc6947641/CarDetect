...
class Main(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_detect.setMinimumSize(QtCore.QSize(250, 40))
        self.pushButton_detect.setMaximumSize(QtCore.QSize(250, 40))
        ...
        self.pushButton_showdir.setMinimumSize(QtCore.QSize(250, 50))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "车辆零部件缺陷检测系统"))
        self.pushButton_img.setText(_translate("MainWindow", "加载数据"))
        self.pushButton_model.setText(_translate("MainWindow", "选择模型"))
        self.pushButton_detect.setText(_translate("MainWindow", "车辆零部件缺陷检测"))
...
if __name__ == '__main__':
    ...
    # 设置窗口图标
    icon = QIcon()
    icon.addPixmap(QPixmap("./IMG/gujilogo.png"), QIcon.Normal, QIcon.Off)
